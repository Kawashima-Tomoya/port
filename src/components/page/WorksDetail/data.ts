...
export const workDetailsData: WorkDetails[] = [
	{
		...
		title: "ポートフォリオサイト",
		description:
			"現在閲覧していただいてる当サイトです。ドキュメントを読んだり動画視聴やコードを書き写すだけではなく、まず手を動かして何かを作ろうと思い制作に至りました。修正や手戻りが何度か発生し、事前の設計が大切であることも実感しました。",
	},
	{
		workId: 2,
		title: "microCMSを使用した架空コーポレートサイト",
		description:
			"「Next.js+ヘッドレスCMSではじめる!かんたんモダンWebサイト制作入門」という本を参考に、独自でTailwindCSSとBiomejsを使用して制作しました。ただコードを書き写すのではなく、まず解説を読み自分なりのコードを書いて、その後修正する方式で実装しました。",
	},
	{
		workId: 3,
		title: "架空ブログサイト",
